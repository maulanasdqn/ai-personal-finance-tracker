...
pub trait BankStatementRepository {
    ...
    async fn update_status(&self, id: &str, status: ProcessingStatus, parsed: Option<serde_json::Value>, summary: Option<String>, updated_at: &str) -> Result<BankStatement, AppError>;
}
