...
import dev.msdqn.finance.data.repository.BankStatementRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds @Singleton abstract fun bindWorkspaceRepository(impl: WorkspaceRepositoryImpl): WorkspaceRepository
    @Binds @Singleton abstract fun bindTransactionRepository(impl: TransactionRepositoryImpl): TransactionRepository
    @Binds @Singleton abstract fun bindInsightRepository(impl: InsightRepositoryImpl): InsightRepository
    @Binds @Singleton abstract fun bindBankStatementRepository(impl: BankStatementRepositoryImpl): BankStatementRepository
}
